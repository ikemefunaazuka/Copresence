import type { DocumentPoint } from './coordinates.js';
 ...
 */
export function withCursor(state: PresenceState, point: DocumentPoint, seq: number): PresenceState {
